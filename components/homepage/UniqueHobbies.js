...
import bookreading from '/public/images/hobbies/book-reading.png'
	...
	return (
		<div className={styles.container}>
			<div className={styles.wrapper}>
				<p className={styles.header}>An Array of unique Hobbies</p>
				<p className={styles.paragraph}>
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam
					accusantium nesciunt illum reiciendis reprehenderit doloremque
					repellat minus deserunt porro sint explicabo numquam repellendus
					dolorem consequatur, ea sit deleniti ratione maiores!
				</p>
