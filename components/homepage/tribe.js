...
import PurpleLine from '/public/images/misc/purple-line.svg'
import TwistedLine from '/public/images/icons/twisted-line.svg'
			...
			<div className={styles.wrapper}>
				<div className={styles.imageContainer}>
					<img
						...
						src={handsImage.src}
						alt="Hands in the shape of Love"
					/>
				</div>
				...
				<div className={styles.paragraph}>
					<p>
						Text here must explain the meanign of an invite only platform. The
						process and benefits of being a member
					</p>
				</div>
				<div className={styles.section1}>
					...
					<div className={styles.items}>
						<p>
							Text here must explain the meaing of an invite only platform. The
							process and benfits of being a member. The process and benefits
							of...
						</p>
					</div>
				</div>
